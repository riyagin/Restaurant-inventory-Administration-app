  ...
  return (
    <div style={{ padding: 24, maxWidth: 720, margin: '0 auto' }}>
      ...
      <p style={{ color: '#667', marginTop: 0, marginBottom: 20 }}>
        Data perusahaan untuk slip gaji, dan pintasan ke pengelolaan karyawan &amp; absensi.
      </p>
      ...
      <div className="card">
        ...
        <p style={{ color: '#889', fontSize: 13, margin: '0 0 16px' }}>Tampil pada kepala slip gaji.</p>
        ...
        <div className="form-group">
          <label>Toleransi Absen per Bulan (hari)</label>
          <input type="number" min={0} value={graceDays}
            onChange={(e) => setGraceDays(e.target.value)} style={{ maxWidth: 140 }} />
          <div style={{ fontSize: 12, color: '#889', marginTop: 6 }}>
            Jumlah hari absen tanpa izin yang tidak mengurangi skor evaluasi tiap bulan.
            Absen melebihi angka ini baru menurunkan skor.
          </div>
        </div>
